  ...
  <div id="app_main">
    ...
    <div class="container mb-3 pt-3">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 justify-content-between d-flex px-0 g-4">
        ...
        <AppFilmCard v-for="film in state.filmData" :film="film" :path="state.url_img + film.poster_path">
        </AppFilmCard>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 justify-content-between d-flex px-0 g-4">
        ...
        <div class="col" v-for="serie in state.seriesData">
          ...
          <div class="mb-4 card">
            ...
            <img class="card-img-top" v-if="serie.poster_path != null" :src="state.url_img + serie.poster_path"
              alt="Title">
